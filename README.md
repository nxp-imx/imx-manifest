...
To download the 6.18.37-2.1.0 release
```
...
```
where
- `<machine>` -- Machine configure file (default: `imx6qsabresd`)
...
- Setup for XWayland.
```
$ MACHINE=imx95evk DISTRO=fsl-imx-xwayland source ./imx-setup-release.sh -b bld-xwayland
```
